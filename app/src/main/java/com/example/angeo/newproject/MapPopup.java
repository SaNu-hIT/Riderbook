...
/**
 * Created by Kichu on 26-02-2018.
 */

public class MapPopup extends FragmentActivity implements
        OnMapReadyCallback,
...
final Status status = locationSettingsResult.getStatus();
        ...
        mGoogleApiClient, mLocationRequest, MapPopup.this);
        break;
        ...
        status.startResolutionForResult(MapPopup.this, REQUEST_CHECK_SETTINGS);
        ...
        Toast.makeText(MapPopup.this, errorMessage, Toast.LENGTH_LONG).show();
        mRequestingLocationUpdates = false;
        }
        updateUI();
        }
