...
/**
 * Created by intellyelabs on 07/03/18.
 */

public class PassengerActivity extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    protected static final String TAG = "PassengerActivity";
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.SUCCESS:
                        ...
                        LocationServices.FusedLocationApi.requestLocationUpdates(
                                mGoogleApiClient, mLocationRequest, PassengerActivity.this);
                        break;
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
...
//                                System.out.println("Eldose: "+ );
                ...
                Toast.makeText(PassengerActivity.this, "Lat: "+ location1.Latitude, Toast.LENGTH_SHORT).show();
...
//        Toast.makeText(this, "CHANGING LOCATION : "+mCurrentLocation_DB.getLatitude()+" "+mCurrentLocation_DB.getLongitude(), Toast.LENGTH_SHORT).show();
                            ...
                            buildGoogleApiClient();
                            if (ActivityCompat.checkSelfPermission(PassengerActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(PassengerActivity.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                                return;
                            }

                            mMap.setMyLocationEnabled(true);
                            Toast.makeText(PassengerActivity.this, "LocationClass "+mCurrentLocation_DB.getLatitude()+" longitude  : "+mCurrentLocation_DB.getLongitude(), Toast.LENGTH_SHORT).show();

                            // Logic to handle location object
                            LocationClass lc=new LocationClass(7.7777777,7.7777777);

//                            Toast.makeText(PassengerActivity.this, "SHANIL", Toast.LENGTH_SHORT).show();
//                            DatabaseReference mDatabase=FirebaseDatabase.getInstance().getReference("Coordinates");
