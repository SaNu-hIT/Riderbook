...
//		if(MyDialog.active){
//			MyDialog.myDialog.finish();
//			Toast.makeText(this,"fghhhhfghg",Toast.LENGTH_LONG).show();
//
//		}else{
//		if(MyDialog.active){
//
...
//		}else {
			//clickcheck = 1;
			Intent it = new Intent(this, Sosactivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(it);
		//}
		//}
